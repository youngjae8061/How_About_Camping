...
import com.example.how_about_camping.DailyItem;

import java.util.List;

public class DailyItemAdapter extends RecyclerView.Adapter<com.example.how_about_camping.DailyItemAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        com.example.how_about_camping.DailyItem item = dailyItems.get(position);
